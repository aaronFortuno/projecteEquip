...
public class mostraplaces2 {
	...
	public static final int SI = 1;// TONI
	public static final int NO = 0;// TONI
	...
	public static void main(String[] args) {
		...
		// TONI
		System.out.println("Per a saber usuaris que han introduit més d'una familia pulsa 0=no o 1=si");
		...
		if (vols_saber == SI) {
			...
			System.out.println("Aquest usuari ha introduit les següents families");
			System.out.println("================================================");
			System.out.println("\nID    places   rus/ucraines   \t\ttipus       \ttelèfon");
